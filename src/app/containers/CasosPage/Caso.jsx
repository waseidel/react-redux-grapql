  ...
  return (
    <div className="border shadow justify-start p-4 my-2 mx-4 bg-gray-200">
      <div className="flex justify-between place-items-center mb-2">
        ...
        <div className="font-semibold uppercase">{caso.tipo}</div>
        <div className="space-x-1">
          ...
          <button className="border rounded bg-red-700 px-2 py-1">
      ...
      <table id={`table-${caso.caso}`}>
        <tbody>
          ...
          <tr>
            <td className="font-semibold">Tarea</td>
            <td>{caso.tarea}</td>
          </tr>
          <tr>
            <td className="font-semibold">Viaje</td>
            <td>{caso.viaje}</td>
          </tr>
          <tr>
            <td className="font-semibold">Lugar</td>
            <td>{caso.parada}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="font-semibold">Línea</td>
            <td>{caso.linea.nombre}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="font-semibold">Jerarquia</td>
            <td>{caso.jerarquia.nombre}</td>
          </tr>
          <tr>
            <td className="font-semibold">Usuario</td>
            <td>{caso.user.name}</td>
          </tr>
        </tbody>
      </table>
    </div>
